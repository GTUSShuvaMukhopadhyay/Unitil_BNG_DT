...
# Add the CONV 3 directory to Python path (only need this once)
...
# File paths
file_path = r"C:\Users\GTUSER1\Documents\CONV 3\ZDM_PREMDETAILS.XLSX"
file_path1 = r"c:\Users\GTUSER1\Documents\CONV 3\BNG Gas Meter Attributes Cleanup Conv_3 08_07_25.xlsx"
config_path = r"C:\Users\GTUSER1\Documents\CONV 3\Configuration 13.xlsx"
file_path2 = r"C:\Users\GTUSER1\Documents\CONV 3\ZINS.XLSX"
print(f"Loading the files")

# Read the Excel file and load the specific sheets
bng_gas_meter_df = pd.read_excel(file_path1, sheet_name='ZINS and Meter Details Table', engine='openpyxl')
...
# Save to CSV
output_path = r"C:\Users\GTUSER1\Documents\CONV 3\output\Group A\STAGE_DEVICE.csv"
