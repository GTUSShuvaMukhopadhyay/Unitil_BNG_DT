...
def apply_meter_exceptions(df):
    ...
    meter_exceptions = {
        ...
        "2513562": {"BILLINGRATE1": "8267", "SALESCLASS1": "8267", "BILLINGRATE2": "9800", "SALESCLASS2": "8267"},
    }
...
# SM updated 8_7_25 for issues:
if data_sources.get("EABL1") is not None:
    data_sources["EABL"] = data_sources["EABL1"]
    print(f"Using EABL1 as primary EABL data source with {len(data_sources['EABL'])} rows")
else:
    print("Error: No EABL data available - this will affect LASTREADING/LASTREADDATE mapping")
