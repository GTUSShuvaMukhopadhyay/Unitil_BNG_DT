...
# Constants
source_directory = r"C:\DV\Unitil\Conversion 3\\"
cache_directory = r"C:\DV\Unitil\Conversion 3\parquet\\"
output_directory = r"C:\DV\Unitil\Conversion 3\output\\"
...
def cleanse_string(value, max_length=None):
    ...
    value = re.sub(r'[^\x00-\x7F]', '', str(value))  # Remove non-ASCII characters (or replace as needed)
    value = value.replace('Æ', "'").replace('û', '-') # Replace known problematic characters
