...
file_paths = {
    "prem": r"ZDM_PREMDETAILS.XLSX",
    "ever": r"EVER.XLSX",
    "active": r"ZNC_ACTIVE_CUS.XLSX",
    "writeoff": r"Write off customer history.XLSX",
    "erdk": r"ERDK.XLSX",
    "zmecon1": r"ZMECON 01012021 to 02132025.xlsx",
    "zmecon2": r"ZMECON 01012015 to 12312020.xlsx"
}
...
try:
    ...
    df_Prem["tax_jurisdiction"] = df_Prem.iloc[:, 31].apply(lambda x: str(x) if pd.notna(x) else "")
...
# Output CSV
output_path = r"STAGE_BILLING_ACC_NODUPS.csv"
