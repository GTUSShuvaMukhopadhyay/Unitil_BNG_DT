# CONV2_STAGE_TRANSACTIONAL_HIST_05212025_1328PM.py
...
# Save to CSV
# --------------------------
output_path = os.path.join(os.path.dirname(list(file_paths.values())[0]), '05212025STAGE_TRANSACTIONAL_HIST.csv')
