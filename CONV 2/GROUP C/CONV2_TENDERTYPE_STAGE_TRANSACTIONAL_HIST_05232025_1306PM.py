# CONV2_TENDERTYPE_STAGE_TRANSACTIONAL_HIST_05232025_1306PM.py
import pandas as pd
import os
import csv
...
df_new["CUSTOMERID"] = df_new["Business Partener"].fillna("")
df_new["LOCATIONID"] = df_new["Premise"].fillna("")
...
output_path = os.path.join(os.path.dirname(list(file_paths.values())[0]), 
                          'TENDERTYPE_STAGE_TRANSACTIONAL_HIST_05232025_1306PM.csv')
