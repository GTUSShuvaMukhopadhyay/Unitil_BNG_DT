# v5_STAGE_METERED_SVCS_REMEDIATION(POST CONV 1 Updated).py
# 
...
file_paths = {
    ...
    "EABL1": r"EABL 01012020 TO 2132025.XLSX",
    "EABL2": r"EABL 01012015 TO 12312019.XLSX",
    "MM": r"METERMULTIPLIER_PressureFactor.xlsx",
...
output_path = os.path.join(os.path.dirname(list(file_paths.values())[0]), 'v5_STAGE_METERED_SVCS_REMEDIATION(POST CONV 1 Updated).csv')
