...
df_new['COMMENTS'] = ""
df_new['COMMENTS2'] = ""
df_new['SERIALNUMBER'] = zins_df.iloc[:, 11].astype(str).str.slice(0, 15)
...
# Save to CSV
output_path = r"C:\Users\US82783\Downloads\MeterInventory.csv"

# List of columns that are numeric and should not have quotes
numeric_columns = [
    'DEVICECODE', 'BUILTCONFIG', 'INSTALLCONFIG', 'OTHERDEVICETYPE1', 
    'OTHERDEVICETYPE2', 'METERMAKE', 'METERSIZE', 'METERKIND', 'METERMODEL',
    'DIALS', 'DEADZEROES', 'READTYPE', 'MULTIPLIER', 'PONUMBER', 'ASSETTAXDISTRICT', 'AMITYPE'
]
