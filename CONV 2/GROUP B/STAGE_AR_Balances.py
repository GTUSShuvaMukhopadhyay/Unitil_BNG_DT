...
file_path = r"1 DFKKOP 01012025 TO 02282025.XLSX"
file_path1 = r"ZDM_PREMDETAILS.XLSX"
file_path2 = r"Configuration.xlsx"
file_path3 = r"ZMECON 01012021 to 02132025.xlsx"
 
file_pathA = r"2 DFKKOP 010123 TO 12312024.XLSX"
file_pathB = r"3 DFKKOP 01012021 TO 12312022.XLSX"
file_pathC = r"4 DFKKOP 01012019 TO 12312020 v1.XLSX"
file_pathD = r"5 DFKKOP 01012017 TO 12312018.XLSX"
...
df_combined = pd.concat([df, dfA, dfB, dfC, dfD], ignore_index=True)
