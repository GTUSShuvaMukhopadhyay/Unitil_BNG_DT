...
# Constants
source_directory = r"C:\Users\US82783\OneDrive - Grant Thornton Advisors LLC\Desktop\python\CONV 2B _ 2nd run\DATA SOURCES\\"
 
file_paths = {
    "active": source_directory + r"ZNC_ACTIVE_CUS.XLSX",
    "erdk": source_directory + r"ERDK.XLSX",
    "ever": source_directory + r"EVER.XLSX",
    "mail": source_directory + r"MAILING_ADDR1 06302025.XLSX",
    "prem": source_directory + r"ZDM_PREMDETAILS.XLSX",
    "writeoff": source_directory + r"ZWRITEOFF_ME1-0701.XLSX",
    "zmecon1": source_directory + r"ZMECON 010115 to 12312020.xlsx",
    "zmecon2": source_directory + r"ZMECON 010121 to 061425.xlsx"}
