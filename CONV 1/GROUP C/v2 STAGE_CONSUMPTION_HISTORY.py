...
# Define file paths
file_paths = {
    "ZDM_PREMDETAILS": r"C:\Users\us85360\Desktop\STAGE_CONSUMPTION_HIST\ZDM_PREMDETAILS.XLSX",
    "ZMECON1": r"C:\Users\us85360\Desktop\STAGE_CONSUMPTION_HIST\ZMECON 01012015 to 12312020.xlsx",
    "ZMECON2": r"C:\Users\us85360\Desktop\STAGE_CONSUMPTION_HIST\ZMECON 01012021 to 02132025.xlsx",
    "EABL1": r"C:\Users\us85360\Desktop\STAGE_CONSUMPTION_HIST\EABL 01012015 TO 12312019.XLSX",
    "EABL2": r"C:\Users\us85360\Desktop\STAGE_CONSUMPTION_HIST\EABL 01012020 TO 2132025.XLSX",
    "MM": r"C:\Users\us85360\Desktop\STAGE_CONSUMPTION_HIST\METERMULTIPLIER_PressureFactor.xlsx",
    "TF": r"C:\Users\us85360\Desktop\STAGE_CONSUMPTION_HIST\ThermFactor.xlsx",
}
...
# --------------------------
# Assign BILLINGRATE and SALESREVENUECLASS based on Rate #1 
# --------------------------
if data_sources.get("ZMECON") is not None:
    print("\nAssigning BILLINGRATE and SALESREVENUECLASS based on Rate #1...")
    ...
    print("No values assigned for BILLINGRATE and SALESREVENUECLASS (ZMECON not available)")
...
# Save to CSV
# --------------------------
output_path = os.path.join(os.path.dirname(list(file_paths.values())[0]), 'v2STAGE_CONSUMPTION_HIST.csv')
