# v3_05092025_1023am_STAGE_CONSUMPTION_HISTORY
# v3_05092025_1023am_STAGE_CONSUMPTION_HIST.py

# updated BILLINGRATE and SALESREVENUECLASS mapping logic - 050925 1022AM
...
# Save to CSV
# --------------------------
output_path = os.path.join(os.path.dirname(list(file_paths.values())[0]), 'v3_05092025_1023am_STAGE_CONSUMPTION_HIST.csv')
