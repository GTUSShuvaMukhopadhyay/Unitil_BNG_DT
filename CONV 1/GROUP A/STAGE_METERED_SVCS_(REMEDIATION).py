# 05052025_STAGE_METERED_SVCS_(POST CONV 1 Updated).py
...
output_path = os.path.join(os.path.dirname(list(file_paths.values())[0]), '05052025_STAGE_METERED_SVCS_(POST CONV 1 Updated).csv')
