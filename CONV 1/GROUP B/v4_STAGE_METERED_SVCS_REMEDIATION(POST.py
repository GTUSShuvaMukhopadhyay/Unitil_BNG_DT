# v4_STAGE_METERED_SVCS_REMEDIATION(POST CONV 1 Updated).py
# 
...
output_path = os.path.join(os.path.dirname(list(file_paths.values())[0]), 'v4_STAGE_METERED_SVCS_REMEDIATION(POST CONV 1 Updated).csv')
